...
export const STYLES: Option[] = [
  ...
  { id: 'anime-scifi-retro', label: 'Anime Sci-Fi Retrô', prompt: '80s anime style, retro-futuristic sci-fi illustration, cel-shaded animation key visual, clean lineart, mecha concept art, detailed mechanical parts, bubble visor glass reflections, vibrant high contrast colors, flat pastel background', category: 'style', subCategory: '5. Estilo Artístico' },
