...
export const ANGLES: Option[] = [
  ...
  { id: 'extreme-low', label: 'Extreme Low Angle (Câmera no Chão)', prompt: 'extreme low angle shot, ground level camera angle', category: 'angle', subCategory: '3. Ângulos Dramáticos', image: '/images/angulos/extreme-low.png' },
  { id: 'contra-plongee-extremo', label: 'Contra-Plongée Extremo', prompt: 'extreme low-angle shot, shot from a very low ground-level perspective looking up, dramatic upward camera angle, vertical perspective convergence, dynamic perspective pointing up', category: 'angle', subCategory: '3. Ângulos Dramáticos', image: '/images/angulos/contra-plongee-extremo.png' },
  { id: 'extreme-high', label: 'Extreme High Angle (Câmera Muito Alta)', prompt: 'extreme high angle view, looking straight down from high altitude', category: 'angle', subCategory: '3. Ângulos Dramáticos', image: '/images/angulos/extreme-high.png' },

  // 4. Ângulos de Personagem
  { id: 'front-view', label: 'Front View (Visão Frontal)', prompt: 'front view portrait, straight-on camera angle', category: 'angle', subCategory: '4. Ângulos de Personagem', image: '/images/angulos/front-view.png' },
  { id: 'side-view', label: 'Side View (Visão de Lado / Perfil)', prompt: 'side view profile, full side portrait', category: 'angle', subCategory: '4. Ângulos de Personagem', image: '/images/angulos/side-view.png' },
  { id: 'back-view', label: 'Back View (Visão Traseira / Costas)', prompt: 'back view profile, character facing away', category: 'angle', subCategory: '4. Ângulos de Personagem', image: '/images/angulos/back-view.png' },
  { id: 'three-quarter', label: 'Three-Quarter View (Três Quartos)', prompt: 'three-quarter camera view, 3/4 view angle', category: 'angle', subCategory: '4. Ângulos de Personagem', image: '/images/angulos/three-quarter.png' },
  { id: 'turnaround', label: 'Turnaround (Vários Ângulos)', prompt: 'Generate a full professional turnaround sheet for the provided subject/reference. Show all necessary orthographic angles and consistent views including front, side, back, 3/4 and top views when needed. Preserve exact visual consistency between every angle including shape, proportions, colors, textures, materials and details. Arrange like an animation/game industry model sheet. Neutral lighting, clean background, ultra detailed, highly organized layout, no perspective distortion, no redesign, no inconsistencies.', category: 'angle', subCategory: '4. Ângulos de Personagem', image: '/images/angulos/turnaround.png' },

  // 5. Ângulos Cinematográficos
  { id: 'through-object', label: 'Through Object (Através de Objeto)', prompt: 'shooting through object camera angle, frame within a frame shot, foreground occlusion', category: 'angle', subCategory: '5. Ângulos Cinematográficos', image: '/images/angulos/through-object.png' },
  { id: 'hidden-camera', label: 'Hidden Camera (Câmera Escondida)', prompt: 'hidden camera angle, spy camera look, voyeuristic framing', category: 'angle', subCategory: '5. Ângulos Cinematográficos', image: '/images/angulos/hidden-camera.png' },
  { id: 'security-camera', label: 'Security Camera (Câmera de Segurança)', prompt: 'security camera angle view, high angle CCTV feed visual style', category: 'angle', subCategory: '5. Ângulos Cinematográficos', image: '/images/angulos/security-camera.png' },
  { id: 'reflection-angle', label: 'Reflection Angle (Através de Reflexo)', prompt: 'reflection angle shot, mirror or water surface reflection composition', category: 'angle', subCategory: '5. Ângulos Cinematográficos', image: '/images/angulos/reflection-angle.png' },
  { id: 'pov-angle', label: 'POV (Ponto de Vista do Personagem)', prompt: 'POV shot, first person camera perspective', category: 'angle', subCategory: '5. Ângulos Cinematográficos', image: '/images/angulos/pov-angle.png' },
  { id: 'ots-low', label: 'OTS Low (Sobre o Ombro Baixo)', prompt: 'over-the-shoulder low angle shot, looking up from behind shoulder', category: 'angle', subCategory: '5. Ângulos Cinematográficos', image: '/images/angulos/ots-low.png' },
  { id: 'ots-high', label: 'OTS High (Sobre o Ombro Alto)', prompt: 'over-the-shoulder high angle shot, looking down from behind shoulder', category: 'angle', subCategory: '5. Ângulos Cinematográficos', image: '/images/angulos/ots-high.png' },

  // 6. Ângulos de Ação (Anime/Mangá)
  { id: 'chase-camera', label: 'Chase Camera (Câmera de Perseguição)', prompt: 'chase camera angle, trailing tracking shot', category: 'angle', subCategory: '6. Ângulos de Ação (Anime/Mangá)', image: '/images/angulos/chase-camera.png' },
  { id: 'hero-perspective', label: 'Hero Perspective (Perspectiva Heroica)', prompt: 'heroic camera perspective, wide angle low hero positioning', category: 'angle', subCategory: '6. Ângulos de Ação (Anime/Mangá)', image: '/images/angulos/hero-perspective.png' },
  { id: 'speed-perspective-angle', label: 'Speed Perspective (Perspectiva de Velocidade)', prompt: 'exaggerated speed perspective camera angle, high speed motion lines', category: 'angle', subCategory: '6. Ângulos de Ação (Anime/Mangá)', image: '/images/angulos/speed-perspective-angle.png' },
  { id: 'overhead-diagonal', label: 'Overhead Diagonal (Diagonal de Cima)', prompt: 'overhead diagonal angle, tilted bird\'s eye camera view', category: 'angle', subCategory: '6. Ângulos de Ação (Anime/Mangá)', image: '/images/angulos/overhead-diagonal.png' },
  { id: 'rotational-angle', label: 'Rotational Angle (Ângulo Rotacional)', prompt: 'rotational camera angle, spinning camera perspective', category: 'angle', subCategory: '6. Ângulos de Ação (Anime/Mangá)', image: '/images/angulos/rotational-angle.png' },
  { id: 'impact-frame-angle', label: 'Impact Frame (Frame de Impacto)', prompt: 'action impact frame camera angle, dynamic shockwave framing', category: 'angle', subCategory: '6. Ângulos de Ação (Anime/Mangá)', image: '/images/angulos/impact-frame-angle.png' },
];
...
export const STYLES: Option[] = [
  ...
  { id: 'aquarela-aplicada', label: 'Aquarela aplicada', prompt: 'Edit and enhance the image by strictly applying a "traditional watercolor" painting technique over the existing lines. Apply an authentic watercolor effect respecting the texture of high-weight paper. Rendering and Lighting: Fill the volumes of the drawing using translucent washes of paint diluted in water. Create very smooth color transitions, apply wet-on-wet effects, display slightly irregular edges where pigment pools, and show the organic, fluid drying of water on the paper. It is strictly forbidden to alter, redraw, distort, or erase the original lineart, contours, or hatching. The original lines must remain intact and visible as the main skeleton of the image. Exclusive Action: The only function is to act as a colorist, filling blank areas with fluid watercolor to give life and volume to what is already drawn. No Additions or Hallucinations: Do not add any new objects, characters, or scenery. Do not apply organic photorealism, 3D textures, or flat-color digital paintings.', category: 'style', subCategory: '1. Pintura Tradicional', image: '/images/styles/aquarela-aplicada.png' },
  ...
  { id: 'guache-ilustrado-storybook', label: 'Guache Ilustrado (Storybook)', prompt: "whimsical children's book illustration style, modern European picture book art, textured gouache and opaque watercolor on cold-press art paper, visible dry brush strokes and organic paper tooth texture, charming minimalist character design with oversized expressive head, delicate stylized features, lush enchanted oversized botanical environment, rich warm-and-cool contrast palette of marigold yellow, coral orange, teal and deep emerald greens, soft dappled storybook sunlight, handcrafted artisanal texture, no photorealism, no 3D render", category: 'style', subCategory: '1. Pintura Tradicional', image: '/images/styles/guache-ilustrado-storybook.png' },
  ...
  { id: 'esboco-construcao-lapis-2b', label: 'Esboço de Construção (Lápis 2B)', prompt: 'step-by-step drawing tutorial layout, showing the artistic construction phases of the subject. On the left: a raw, very light 2B pencil sketch with visible geometric guide shapes, circles, cross-axis guidelines, and structural lines. On the right: the clean, beautifully finished drawing in detailed 2B pencil with delicate graphite shading, fine cross-hatching, and rich pencil textures. Set on a slightly textured white sketch paper, traditional hand-drawn process, pure graphite pencil art style, no digital painting, no ink, high contrast grey tones', category: 'style', subCategory: '2. Desenho Tradicional', image: '/images/styles/esboco-construcao-lapis-2b.png' },
  { id: 'esboco-construcao-lapis-2b-aplicado', label: 'Esboço de Construção Aplicado', prompt: 'strictly convert the reference image into a traditional step-by-step drawing tutorial layout. It must display the construction process: on the left, a very light 2B pencil sketch detailing the structural geometry, guide circles, cross-axial lines, and loose gestures. On the right, show the final, clean, and beautifully rendered version of the same subject using detailed 2B pencil shading, soft graphite cross-hatching, and delicate textures on white sketch paper. Preserve the original subject, pose, and composition, converting it into a traditional graphite sketch drawing tutorial', category: 'style', subCategory: '2. Desenho Tradicional', image: '/images/styles/esboco-construcao-lapis-2b-aplicado.png' },
  ...
  { id: 'aguada-nanquim', label: 'Aguada com nanquim', prompt: 'Edit and enhance the image by strictly applying an "ink wash" shading technique over the existing lines. Apply the effect of diluted india ink in water (ink wash / sumi-e style). Create volume and depth in the drawing using translucent washes and smooth transitions of gray tones. Shading should simulate the organic pooling and drying of liquid ink on paper, varying opacity between very light grays and intense blacks in deepest shadows. Colors: The final image must be strictly monochromatic (shades of black, gray, and white). It is strictly forbidden to alter, redraw, or erase the original lineart, contours, or hatching of the pencil/pen drawing. Original lines must remain as the visible main skeleton of the image. The exclusive function is to fill blank spaces with fluid ink wash shading to give volume to what is already drawn. Do not add any new objects, characters, or scenery. Do not add colors or organic photorealism.', category: 'style', subCategory: '3. Tinta e Line Art', image: '/images/styles/aguada-nanquim.png' },
  ...
  { id: 'arte-final-comics-nanquim', label: 'Arte Final Comics Nanquim', prompt: 'professional American comic book inking style, sharp black india ink lines, high-contrast pure black and white, dynamic line weight variation, expressive tapered outlines, precise hatching and cross-hatching shadows, deep solid spotting blacks, clean white paper background, no gray tones, no gradients, no digital coloring', category: 'style', subCategory: '3. Tinta e Line Art', image: '/images/styles/arte-final-comics-nanquim.png' },
  { id: 'arte-final-comics-nanquim-aplicada', label: 'Arte Final Nanquim Aplicada', prompt: 'strictly convert the image into professional American comic book inking style, sharp black india ink outlines, dynamic line weight variation, precise hatching shadows, deep solid spotting blacks, pure black and white contrast, preserving original composition, no gray tones, no colors', category: 'style', subCategory: '3. Tinta e Line Art', image: '/images/styles/arte-final-comics-nanquim-aplicada.png' },
  ...
  { id: 'david-aja-arte-final', label: 'David Aja (Arte Final)', prompt: 'Edit and enhance the image by strictly applying a professional comic book inking technique in the style of David Aja. Convert the drawing into clean, minimalist black ink lines with elegant line economy and high-contrast solid black shadows. Use heavy spotting of black blocks (spot blacks) and sharp geometric shadows to create depth. Maintain an absolute monochromatic black-and-white look with no gray tones, no gradients, and no colors. The original pencil lines must be converted into bold, precise black ink contours on a clean white paper background.', category: 'style', subCategory: '3. Tinta e Line Art', image: '/images/styles/david-aja-arte-final.png' },
  { id: 'chaboute', label: 'Chabouté', prompt: 'in the distinct graphic novel style of Christophe Chabouté, high-contrast black and white ink illustration, chiaroscuro, heavy ink brush strokes, gritty hand-drawn line art, pure black and white, dramatic lighting with deep solid black shadows', category: 'style', subCategory: '3. Tinta e Line Art', image: '/images/styles/chaboute.png' },
  { id: 'chaboute-aplicado', label: 'Chabouté Aplicado', prompt: 'strictly convert the image into the distinct graphic novel style of Christophe Chabouté, high-contrast black and white ink illustration, chiaroscuro, heavy black ink brush strokes, gritty hand-drawn line art, pure black and white contrast, deep solid black shadows, stark white highlights, preserving the original pose and composition, no gray tones, no colors', category: 'style', subCategory: '3. Tinta e Line Art', image: '/images/styles/chaboute-aplicado.png' },
  { id: 'darwyn-cooke-traco', label: 'Darwyn Cooke (Traço)', prompt: 'comic book art style of Darwyn Cooke, bold retro ink brush linework, clean mid-century graphic novel aesthetic, elegant line economy, dynamic stylized anatomy, strong solid spotting blacks, expressive contours on white paper', category: 'style', subCategory: '3. Tinta e Line Art' },
  ...
  { id: 'caricatura-cartoon', label: 'Caricatura Cartoon', prompt: 'vibrant 2D cartoon caricature illustration, exaggerated expressive character design, charming facial acting, dynamic hand-drawn black ink line art with organic scratchy hatching and subtle ink splatters, warm painterly digital shading, rich soft textures, clean white background, high-appeal animated cartoon concept art', category: 'style', subCategory: '5. Estilo Artístico', image: '/images/styles/caricatura-cartoon-aplicada.png' },
  { id: 'caricatura-cartoon-aplicada', label: 'Caricatura Cartoon Aplicada', prompt: 'strictly transform the reference image into a vibrant 2D cartoon caricature illustration in the exact artistic style of the reference model. Features exaggerated expressive character design, charming facial acting, dynamic hand-drawn black ink line art with organic scratchy hatching and subtle ink splatters. Rendered with warm painterly digital shading, rich soft textures, clean white background. Preserves recognizable subject identity, pose, and composition while reimagining all details in high-appeal animated cartoon caricature art.', category: 'style', subCategory: '5. Estilo Artístico', image: '/images/styles/caricatura-cartoon-aplicada.png' },
  { id: 'comic-fun', label: 'Comic fun', prompt: 'high appeal cartoon character design, expressive caricature deformation, stylized facial anatomy, simplified geometric forms, classic animated film aesthetics, emotionally expressive character acting, strong silhouette language, playful proportions, exaggerated expressions, hand-crafted animation design sensibility, believable caricature, appealing asymmetry, visual rhythm in shapes, clean stylized construction', category: 'style', subCategory: '5. Estilo Artístico' },
  ...
  { id: 'anime-retro-80s', label: 'Anime Retrô (Anos 80)', prompt: '80s anime style illustration, clean black outlines, hand-drawn retro anime aesthetic, flat colors with hard shadows, cel-shaded animation cel texture, high contrast, vibrant color palette, flat pastel background', category: 'style', subCategory: '5. Estilo Artístico' },
  ...
  { id: 'cute-stylized-3d', label: '3D Estilizado Fofo', prompt: 'cute stylized 3D character design, soft cozy aesthetic, whimsical proportions, rounded shapes, oversized expressive eyes, fluffy textured hair, soft fabric textures, subtle fuzzy surface detail, cinematic soft lighting, pastel muted colors, charming animated movie style, pixar-inspired stylization, handcrafted feel, highly appealing character design, smooth rendering, adorable expression, clean minimal background, stylized realism, cozy atmosphere', category: 'style', subCategory: '6. Digital', image: '/images/styles/cute-stylized-3d.png' },
  { id: '2d-estilo-soft', label: '2D Estilo Soft', prompt: 'Artistic 2D character design, modern animation with strong visual influence from Pixar and Disney TV concept art, concept art for 3D animation perfectly converted to 2D semi-cartoon render. Extremely smooth digital painting, clean polished edges, simplified structural volumes, clear silhouette. Caricatured proportions, large head, stylized legs. Detail concentrated on face with exaggerated captivating expressions. Soft cinematic lighting and shadows, warm harmonious color palette. Pure clean digital aesthetic of modern animation, no photorealism, no organic textures, no skin pores, no realistic hair, no textured fabrics.', category: 'style', subCategory: '6. Digital', image: '/images/styles/2d-estilo-soft.png' },
  ...
  { id: 'david-aja-cores', label: 'David Aja (Cores)', prompt: 'Edit and enhance the image by applying the signature flat color palette of David Aja. Color the drawing using solid, flat color blocks with a very limited retro comic book color scheme, focusing on muted purple, mustard yellow, dark red, and cream tones. The colors must fill the spaces cleanly under the existing lines without adding new linework or modifying the original contours. Strictly flat colors, no digital gradients, no soft shading, no 3D textures, simulating traditional flat screenprint coloring on vintage off-white paper.', category: 'style', subCategory: '8. Cor e Finalização', image: '/images/styles/david-aja-cores.png' },
  ...
  { id: 'bruce-tim-2', label: 'Bruce tim 2', prompt: 'black and white clean line art illustration in the 1990s animated series style inspired by Bruce Timm, bold clean outlines, heavy solid black ink shadows, high-contrast chiaroscuro, no shading, no gray tones, minimalist geometric anatomy, dynamic pose, retro Art Deco cityscape background, pure black ink on clean white paper background', category: 'style', subCategory: '11. Estilos de Traço', image: '/images/styles/bruce-tim-2.png' },
  { id: 'david-aja', label: 'David Aja (Completo)', prompt: 'Flat graphic novel comic book illustration in the distinct art style of David Aja. Minimalist ink drawing, elegant clean lines with precise line economy, sharp flat geometric shadows, strong graphic design layout. Very limited color palette utilizing solid color blocks of purple, mustard yellow, dark red, and cream. Off-white textured paper background, clean negative space, flat design, no gradients, retro comic aesthetic --style raw --v 6', category: 'style', subCategory: '11. Estilos de Traço', image: '/images/styles/david-aja.png' },
  ...
  { id: 'boneco-feltro-3d', label: 'Boneco de Feltro 3D', prompt: 'cute 3D character design, felt toy and claymation aesthetic, soft tactile needle-felted texture, cozy knitted wool clothing, large expressive glossy eyes, soft studio lighting, clean solid background, handcrafted look', category: 'style', subCategory: '13. Efeitos de Elementos e Materiais', image: '/images/styles/boneco-feltro-3d.png' },
  { id: 'neve', label: 'Neve', prompt: 'Masterpiece representation entirely covered in fresh, fluffy white snow and sparkling ice crystals. Soft mounds of pristine snow pile up on the contours, with delicate snowflakes gently falling in the air. The surfaces have a realistic winter frost texture, catching the cool morning light. Color palette dominated by clean whites, soft icy blues, and pale silver tones. Soft volumetric winter lighting, cinematic atmosphere, highly detailed, photorealistic snow texture, 8k --stylize 120 --v 6 --style raw', category: 'style', subCategory: '13. Efeitos de Elementos e Materiais', image: '/images/styles/neve.png' },
  { id: 'neve-aplicada', label: 'Neve aplicada', prompt: 'Edit and enhance the image by strictly applying a realistic winter snow effect. Keep the original subject, pose, and structure completely intact and recognizable. Cover the surfaces with a layer of fresh, fluffy white snow, adding delicate accumulations of ice and frost on the edges and horizontal surfaces. The atmosphere should have soft falling snowflakes in the air. Apply cool winter lighting with subtle blue and silver reflections. Do not alter or distort the core subject; only apply the snow and winter frost layer to the scene.', category: 'style', subCategory: '13. Efeitos de Elementos e Materiais', image: '/images/styles/neve-aplicada.png' },
