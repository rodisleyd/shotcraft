...
export const STYLES: Option[] = [
  ...
  { id: 'caricatura-cartoon', label: 'Caricatura Cartoon', prompt: 'vibrant 2D cartoon caricature illustration, exaggerated expressive character design, charming facial acting, dynamic hand-drawn black ink line art with organic scratchy hatching and subtle ink splatters, warm painterly digital shading, rich soft textures, stylized textured orange square background block with rough brush edges on off-white paper canvas, high-appeal animated cartoon concept art', category: 'style', subCategory: '5. Estilo Artístico', image: '/images/styles/caricatura-cartoon-aplicada.png' },
  { id: 'caricatura-cartoon-aplicada', label: 'Caricatura Cartoon Aplicada', prompt: 'strictly transform the reference image into a vibrant 2D cartoon caricature illustration in the exact artistic style of the reference model. Features exaggerated expressive character design, charming facial acting, dynamic hand-drawn black ink line art with organic scratchy hatching and subtle ink splatters. Rendered with warm painterly digital shading, rich soft textures, set against a stylized textured orange square background block with rough brush edges on off-white paper canvas. Preserves recognizable subject identity, pose, and composition while reimagining all details in high-appeal animated cartoon caricature art.', category: 'style', subCategory: '5. Estilo Artístico', image: '/images/styles/caricatura-cartoon-aplicada.png' },
