...
export const STYLES: Option[] = [
  ...
  { id: 'croqui', label: 'Croqui', prompt: `A raw artist's sketchbook page, full-body expressive gestural ink-and-pencil sketch of a figure from behind. High-contrast black ink cross-hatching is used to create heavy, dense shadow patches on the lower legs and the figure's scruffy hair. Minimalist, rough, scratching lines with varying weight define the figure's hooded jacket. The figure is posed holding a shopping tote and standing by a large rolling suitcase. A few abstract, floating ink marks are in the white space. Monochromatic.`, category: 'style', subCategory: '3. Tinta e Line Art' },
