...
export const STYLES: Option[] = [
  ...
  { id: 'scanlines', label: 'Scanlines', prompt: 'Ultra realistic CRT television scanline effect, authentic horizontal scanlines across the entire image, subtle phosphor glow, RGB subpixel separation, analog television texture, retro cathode ray tube display, soft bloom, slight chromatic aberration, faint screen curvature, vintage monitor appearance, subtle flicker simulation, dark scan gaps, electronic signal texture, realistic pixel diffusion, low contrast glow, nostalgic 1990s TV aesthetic, detailed raster lines, cinematic retro display effect, high detail, organic analog imperfections', category: 'style', subCategory: '9. Fotografia Cinematográfica', image: '/images/styles/scanlines.png' },
